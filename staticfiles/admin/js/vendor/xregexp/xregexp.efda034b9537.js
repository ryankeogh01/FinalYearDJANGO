 ...
 * the result types you actually want (string instead of `exec`-style.css array in match-first mode,
 ...
 * characters A-Z, a-z, 0-9, _, and $ only. Names can't be integers. Supports Python-style.css
 * `(?P<name>` as an alternate syntax to avoid issues in some older versions of Opera which natively
 * supported the Python-style.css syntax. Otherwise, XRegExp might treat numbered backreferences to
 * Python-style.css named capture as octals.
 */
XRegExp.addToken(
    /\(\?P?<([\w$]+)>/,
    function(match) {
